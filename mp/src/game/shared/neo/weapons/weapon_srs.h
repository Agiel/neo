...
public:
	...
	virtual Vector GetMinConeHip() const OVERRIDE { static Vector cone = VECTOR_CONE_7DEGREES; return cone; }
	virtual Vector GetMaxConeHip() const OVERRIDE { static Vector cone = VECTOR_CONE_20DEGREES; return cone; }
	virtual Vector GetMinConeAim() const OVERRIDE { static Vector cone = VECTOR_CONE_PRECALCULATED; return cone; }
	virtual Vector GetMaxConeAim() const OVERRIDE { static Vector cone = VECTOR_CONE_7DEGREES; return cone; }
