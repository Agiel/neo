...
public:
	...
	virtual Vector GetMinConeHip() const { static Vector cone = VECTOR_CONE_1DEGREES; return cone; }
	virtual Vector GetMaxConeHip() const { static Vector cone = VECTOR_CONE_10DEGREES; return cone; }
	virtual Vector GetMinConeAim() const { static Vector cone = VECTOR_CONE_1DEGREES; return cone; }
	virtual Vector GetMaxConeAim() const { static Vector cone = VECTOR_CONE_10DEGREES; return cone; }
