...
public:
	...
	virtual Vector GetMinConeHip() const OVERRIDE { static Vector cone = VECTOR_CONE_3DEGREES; return cone; }
	virtual Vector GetMaxConeHip() const OVERRIDE { static Vector cone = VECTOR_CONE_10DEGREES; return cone; }
